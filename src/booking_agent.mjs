...
import { api_key } from './secure_data.mjs';
import { auth_token } from './secure_data.mjs';

let day = "2023-04-10";
let timeHour = 19;
let timeMinute = 30;
let window = 45; //time to look before and after if reservation not available (in minutes)
let diningLoc = "Dining Room"; //set to null if doesn't matter
let party_size = "2";
let venue_id = "443";
let allowedIter = 3; //should be like 500 for midnights //200 is roughly 24 seconds
let currentIter = 0;
